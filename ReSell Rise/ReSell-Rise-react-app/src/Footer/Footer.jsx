    ...
    <>
      <div className="maindiv w-full flex justify-center  bg-gray-200 ">
        <div className="w-[70%] h-[130px]  text-zinc-500 flex text-xs justify-between mt-6">
          <ul className="space-y-1">
            <li className="font-bold text-sm mb-2 text-black">
              POPULAR LOCATIONS
            </li>
            <li>Kolkata</li>
            <li>Mumbai</li>
          ...
          <ul className="space-y-1">
            <li className="font-bold mb-2 text-sm text-black">
              TRENDING LOCATIONS
            </li>
            <li>Bhubaneshwar</li>
            <li>Hyderabad</li>
          ...
          <ul className="space-y-1">
            <li className="font-bold mb-2 text-sm text-black">ReSell Rise</li>
            <li>Help</li>
            <li>Sitemap</li>
      ...
      <div className="backgoundgreenfooter h-[60px] flex justify-center">
        <div className="w-[75%] font-semibold  text-white flex text-xs justify-between items-center">
          ...
          <div>All rights reserved &copy; 2006-2024 ResellRise</div>
        </div>
      </div>
      {/* </div> */}
    </>
